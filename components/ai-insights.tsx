...
import { CircleCheck, AlertCircle, TrendingUp, DollarSign, Percent, Brain, Download, Share2 } from "lucide-react"
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500">Our AI has analyzed your loan application and provided the following insights</p>
        </div>
      ...
      <Tabs defaultValue="overview">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">
                      Your loan application shows a strong likelihood of approval with an 87% success probability. Your
                      credit score, income level, and employment history are all positive factors in your application.
                    </p>
                  </div>
                </div>
        ...
        <TabsContent value="success">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Detailed breakdown of factors affecting your loan approval probability</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="recommendations">
          <Card>
                ...
                <div className="border rounded-lg p-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mt-1">
                        Reducing your loan term from 60 to 48 months could lower your interest rate by 0.3%. While your
                        monthly payment would increase to $442, you would save $1,240 in interest over the life of the
                        loan.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mt-1">
                        ...
                        increase your approval probability by 5-7%. This would also potentially qualify you for a better
                        interest rate.
                      </p>
                    </div>
                  </div>
            ...
            <CardFooter>
              <Button className="w-full bg-[#0a1525] hover:bg-[#1a2b45]">Apply These Recommendations</Button>
            </CardFooter>
          </Card>
        </TabsContent>
      </Tabs>
